...
public class RiemannAppenderTestTmp {
  ...
  @Test
  public void riemannServicenameShouldDefaultServicename() throws Exception {
    RiemannAppender<ILoggingEvent> appender = new RiemannAppender<ILoggingEvent>();
    assertThat(appender.toString(), containsString("serviceName=*no-service-name*"));
  }

  @Test
  public void riemannServicenameShouldBeOverridableViaSystemProperty() throws Exception {
    String riemannServiceName = UUID.randomUUID().toString();
    System.setProperty("riemann.serviceName", riemannServiceName);
    RiemannAppender<ILoggingEvent> appender = new RiemannAppender<ILoggingEvent>();
    String riemannServicenameProperty = UUID.randomUUID().toString();
    appender.setServiceName(riemannServicenameProperty);
    assertThat(appender.toString(), containsString("serviceName=" + riemannServicenameProperty));
  }
